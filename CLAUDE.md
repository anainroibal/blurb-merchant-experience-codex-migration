...
- **The home page is back** *(2026-08-24)*, carrying a lane for the Instant Store — the new channel, the only one where the price is the seller's. It is a doorway: **no figures**, because the home page is what keeps retail pricing retail. Its second hero prompt goes to the pricing calculator, since `/pdf-to-book` is not in this build.

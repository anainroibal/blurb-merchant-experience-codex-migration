...
- **A selling lane sits after the catalogue grid** *(2026-08-24)*, promoting the Instant Store and the margin estimator. After the products, not above them: choosing a product is the first question and selling is the second. **No figures on it** — `/formats` is a retail page, and the margin lives behind the door.

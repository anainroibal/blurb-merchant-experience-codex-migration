...
- **The Instant Store page is a placeholder** *(2026-08-24)*. **Crometrics is building it.** Ours exists only so the links into it can be reviewed; it names the owner and lists what the page has to answer, each line pointing at where this project already decided it. Do not design it.

...
- **The seller page is `/self-publish`** *(2026-08-24)*, with the live page's heading, and its "Choose how to sell your book" section rebuilt with **four cards instead of three** — the live copy for Bookstore, Amazon and Ingram, bullet for bullet, plus the Instant Store card that page is missing. That addition is the change this page argues for; the comparison table underneath does what no card set can, which is read one fact across all four.
